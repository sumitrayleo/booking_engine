...
import com.ehi.msi.enterprisecarshare.dto.ErrorResponse;
import com.ehi.msi.enterprisecarshare.dto.MsiError;
import com.ehi.msi.enterprisecarshare.enumeration.ReturnCodeEnum;
import com.ehi.msi.enterprisecarshare.exception.AuthenticationTokenNotFoundException;
...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ErrorResponse> handleDefault(Exception exception,
			HttpServletRequest httpServletRequest) {
		loggingUtil.logError(exception,
				appendClientInformation(httpServletRequest));
