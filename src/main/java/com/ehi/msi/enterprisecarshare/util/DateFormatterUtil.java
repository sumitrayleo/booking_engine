...
/**
 * Formatter Utility class for Date. It takes in an integer and converts into a
...
public final class DateFormatterUtil {
	...
	/**
	 * This utility method creates a formatted date, consumable for LRD services
	 * from primitive in date
	 * 
	...
	public static String createFormattedDate(final Integer requestedDateTime) {
		...
		if (requestedDateTime != null) {
			requestDate = dateFormat
					.format(new Date(requestedDateTime * 1000L));
		} else {
